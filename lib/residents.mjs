...
export const DIG_NORMAL = [
  {
    id: "utouto",
    name: "うとうとはにわ",
    oneLiner: "まぶたの開閉が、きょうの仕事",
    assetBase: "assets/resident-dig-utouto",
  },
  {
    id: "nobinobi",
    name: "のびのびはにわ",
    oneLiner: "腕も心も、のばしてよし",
